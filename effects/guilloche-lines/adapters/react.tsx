/*
 * React adapter for Guilloche. Thin on purpose. It wires a ref to the core and
...
import { createGuillocheLines, type GuillocheLinesOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type GuillocheLinesProps = Partial<GuillocheLinesOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Guilloche({ className, autoStart = true, ...options }: GuillocheLinesProps) {
  ...
  useEffect(() => {
    ...
    const effect = createGuillocheLines(host.current, options)
