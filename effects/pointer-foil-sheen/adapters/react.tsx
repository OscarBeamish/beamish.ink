...
import { createPointerFoilSheen, type PointerFoilSheenOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type PointerFoilSheenProps = Partial<PointerFoilSheenOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Foil({ className, autoStart = true, ...options }: PointerFoilSheenProps) {
  ...
  useEffect(() => {
    ...
    const effect = createPointerFoilSheen(host.current, options)
