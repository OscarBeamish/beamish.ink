...
import { createSwell, type SwellOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type SwellProps = Partial<SwellOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Swell({ className, autoStart = true, ...options }: SwellProps) {
  ...
  useEffect(() => {
    ...
    const effect = createSwell(host.current, options)
