...
import { createSundial, type SundialOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type SundialProps = Partial<SundialOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Sundial({ className, autoStart = true, ...options }: SundialProps) {
  ...
  useEffect(() => {
    ...
    const effect = createSundial(host.current, options)
