...
import { createTerrainRelief, type TerrainReliefOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type TerrainReliefProps = Partial<TerrainReliefOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Contour({ className, autoStart = true, ...options }: TerrainReliefProps) {
  ...
  useEffect(() => {
    ...
    const effect = createTerrainRelief(host.current, options)
