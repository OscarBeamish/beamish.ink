/*
 * React adapter for Sundial. Thin on purpose. It wires a ref to the core and
...
import { createCastShadowScene, type CastShadowSceneOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type CastShadowSceneProps = Partial<CastShadowSceneOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Sundial({ className, autoStart = true, ...options }: CastShadowSceneProps) {
  ...
  useEffect(() => {
    ...
    const effect = createCastShadowScene(host.current, options)
