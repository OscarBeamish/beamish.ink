...
import { createCountUpNumber, type CountUpNumberOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type CountUpNumberProps = Partial<CountUpNumberOptions> & {
  children: string
  className?: string
...
export function Tally({ children, className, as: Tag = 'span', autoStart = true, ...options }: CountUpNumberProps) {
  ...
  useEffect(() => {
    ...
    const effect = createCountUpNumber(host.current, options)
