/*
 * React adapter for Vellum. Thin on purpose. It wires a ref to the core and
...
import { createTranslucentSheets, type TranslucentSheetsOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type TranslucentSheetsProps = Partial<TranslucentSheetsOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Vellum({ className, autoStart = true, ...options }: TranslucentSheetsProps) {
  ...
  useEffect(() => {
    ...
    const effect = createTranslucentSheets(host.current, options)
