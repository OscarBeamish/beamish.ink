...
import { createScrambleText, type ScrambleTextOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type ScrambleTextProps = Partial<ScrambleTextOptions> & {
  children: string
  className?: string
...
export function Sort({ children, className, as: Tag = 'span', autoStart = true, ...options }: ScrambleTextProps) {
  ...
  useEffect(() => {
    ...
    const effect = createScrambleText(host.current, options)
