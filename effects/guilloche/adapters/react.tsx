...
import { createGuilloche, type GuillocheOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type GuillocheProps = Partial<GuillocheOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Guilloche({ className, autoStart = true, ...options }: GuillocheProps) {
  ...
  useEffect(() => {
    ...
    const effect = createGuilloche(host.current, options)
