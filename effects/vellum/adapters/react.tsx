...
import { createVellum, type VellumOptions } from '../core'
import type { EffectHandle } from '../../../shared/runtime'

export type VellumProps = Partial<VellumOptions> & {
  className?: string
  /** Set false to mount without starting. Useful behind your own pause control. */
  autoStart?: boolean
}

export function Vellum({ className, autoStart = true, ...options }: VellumProps) {
  ...
  useEffect(() => {
    ...
    const effect = createVellum(host.current, options)
