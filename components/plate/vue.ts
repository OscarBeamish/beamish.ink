...
export const Plate = defineComponent({
  name: 'Plate',
  props: {
    plates: { type: Array as PropType<PlateItem[]>, required: true },
  ...
  setup(props, { emit }) {
    ...
    const titleId = `beamish-plate-${(uid += 1)}`
    ...
    const sr = (text: string) => h('span', { class: 'beamish-plate__sr' }, text)

    const renderSheet = () =>
      h(
        'ul',
        {
          class: 'beamish-plate__sheet',
        ...
        props.plates.map((plate, i) =>
          h(
            ...
            {
              key: plate.src,
              class: 'beamish-plate__cell'
            },
            [
              h('figure', { class: 'beamish-plate__figure' }, [
                h(
                  'button',
                  {
                    type: 'button',
                    class: 'beamish-plate__trigger',
                  ...
                  [
                    ...
                    h(
                      'span',
                      { class: 'beamish-plate__number', 'aria-hidden': 'true' },
                      String(i + 1).padStart(2, '0')
                    )
                  ]
                ),
                plate.caption
                  ? h('figcaption', { class: 'beamish-plate__caption' }, plate.caption)
                  : null
              ])
            ]
          )
    ...
    const renderOpen = () => {
      ...
      return h('figure', { class: 'beamish-plate__open' }, [
        h('img', {
        ...
        h('figcaption', { class: 'beamish-plate__bar' }, [
          h('span', { class: 'beamish-plate__count' }, [
            h(
              'span',
              { 'aria-hidden': 'true' },
          ...
          plate.caption
            ? h('span', { class: 'beamish-plate__text', id: captionId }, plate.caption)
            : null
        ])
      ])
    }
    ...
    const renderControls = () =>
      h('div', { class: 'beamish-plate__controls' }, [
        h(
          'button',
          {
            type: 'button',
            class: 'beamish-plate__nav',
        ...
        h(
          'button',
          { type: 'button', class: 'beamish-plate__close', onClick: () => setOpen(null) },
          props.closeLabel
        ),
        /*
    ...
    return () => [
      ...
      h(
        ...
        [
          h('h2', { class: 'beamish-plate__sr', id: titleId }, props.label),
          h('div', { class: 'beamish-plate__inner' }, [
            h(
              'div',
              {
                class: 'beamish-plate__stage',
                /*
