...
**`src/beamish/components/fullscreen-menu/react.tsx`**
...
**`src/beamish/components/fullscreen-menu/styles.css`**
...
.beamish-fullscreen-menu,
.beamish-fullscreen-menu__trigger {
...
.beamish-fullscreen-menu__trigger:hover {
  background-color: color-mix(in srgb, currentColor 8%, transparent);
}

.beamish-fullscreen-menu__trigger:focus-visible {
...
.beamish-fullscreen-menu::backdrop {
  background: rgb(var(--contents-paper) / 0.6);
  backdrop-filter: blur(6px);
}

.beamish-fullscreen-menu__inner {
  height: 100%;
  overflow-y: auto;
...
.beamish-fullscreen-menu__title {
  margin: 0;
  font-size: 0.8rem;
  font-weight: 500;
  letter-spacing: 0.08em;
...
.beamish-fullscreen-menu__close {
  appearance: none;
  background: none;
  border: 1px solid var(--contents-line);
  border-radius: 100px;
...
.beamish-fullscreen-menu__close:hover {
  background-color: color-mix(in srgb, var(--contents-line) 10%, transparent);
}

.beamish-fullscreen-menu__close:focus-visible {
  outline: 2px solid var(--contents-ink);
  outline-offset: 3px;
}

.beamish-fullscreen-menu__lede {
  max-width: 46ch;
...
.beamish-fullscreen-menu__nav {
  display: grid;
  gap: clamp(1.5rem, 4vw, 2.75rem);
}

.beamish-fullscreen-menu__heading {
  margin: 0 0 0.5rem;
  font-size: 0.75rem;
  font-weight: 500;
...
.beamish-fullscreen-menu__list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.beamish-fullscreen-menu__item {
...
.beamish-fullscreen-menu[open] .beamish-fullscreen-menu__item {
  opacity: 1;
  transform: none;
}

.beamish-fullscreen-menu__link {
  display: flex;
...
.beamish-fullscreen-menu__label {
  font-size: clamp(1.35rem, 4.2vw, 2.1rem);
  letter-spacing: -0.02em;
  line-height: 1.1;
}

.beamish-fullscreen-menu__meta {
  flex: none;
  font-size: 0.75rem;
  letter-spacing: 0.08em;
  text-transform: uppercase;
...
.beamish-fullscreen-menu__link:hover,
.beamish-fullscreen-menu__link:focus-visible {
