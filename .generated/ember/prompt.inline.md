...
**`src/beamish/components/ember/react.tsx`**
...
**`src/beamish/components/ember/styles.css`**
...
.beamish-ember:disabled,
.beamish-ember[aria-disabled='true'] {
  opacity: 0.45;
  cursor: not-allowed;
}
 ...
 */
.beamish-ember--solid:hover:not(:disabled) {
...
.beamish-ember--quiet:hover:not(:disabled) {
...
.beamish-ember:hover:not(:disabled)::after,
.beamish-ember:focus-visible::after {
  transform: translateX(130%) rotate(14deg);
}

.beamish-ember:active:not(:disabled) {
