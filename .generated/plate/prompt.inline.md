...
**`src/beamish/components/plate/react.tsx`**
...
**`src/beamish/components/plate/styles.css`**
...
.beamish-plate__figure {
  margin: 0;
  display: grid;
  gap: 0.6rem;
}

.beamish-plate__trigger {
  appearance: none;
  padding: 0;
...
.beamish-plate__trigger:hover .beamish-plate__thumb {
  transform: scale(1.03);
}

.beamish-plate__trigger:focus-visible {
...
.beamish-plate__image {
  ...
  display: block;
  border: 1px solid var(--plate-rule);
  animation: beamish-plate-in 0.5s var(--plate-expo) both;
}

/* Enters from the side you asked for. data-direction is set by the component. */
@keyframes beamish-plate-in {
  from {
    opacity: 0;
...
.beamish-plate[data-direction='-1'] {
  --plate-from: -1;
}
...
.beamish-plate__nav:hover,
.beamish-plate__close:hover,
.beamish-plate__play:hover {
  background-color: color-mix(in srgb, currentColor 8%, transparent);
}

.beamish-plate__nav:focus-visible,
.beamish-plate__close:focus-visible,
.beamish-plate__play:focus-visible {
  outline: 2px solid currentColor;
  outline-offset: 3px;
}

.beamish-plate__play[aria-pressed='true'] {
